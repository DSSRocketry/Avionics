/*
  Drawn from the StandaloneFlash example in the BHY2 library

    Shows how to use Nicla in standalone mode and how to save data
    the on-board 2MB SPI Flash using the LittleFS filesystem.
